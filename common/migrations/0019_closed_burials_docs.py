...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClosedBurial.document'
        db.add_column('common_closedburial', 'document', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClosedBurial.document'
        db.delete_column('common_closedburial', 'document')
