...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Person', fields ['birth_location']
        db.delete_unique('common_person', ['birth_location_id'])

        # Changing field 'Person.birth_location'
        db.alter_column('common_person', 'birth_location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.SimpleLocation'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Person.birth_location'
        db.alter_column('common_person', 'birth_location_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['common.SimpleLocation'], unique=True, null=True))

        # Adding unique constraint on 'Person', fields ['birth_location']
        db.create_unique('common_person', ['birth_location_id'])
