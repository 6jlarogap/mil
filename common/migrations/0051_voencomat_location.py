...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comissariat.name'
        db.alter_column('common_comissariat', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Comissariat.name'
        raise RuntimeError("Cannot reverse this migration. 'Comissariat.name' and its values cannot be restored.")
