...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Person.additional_info'
        db.delete_column('common_person', 'additional_info')

        # Adding field 'Person.info'
        db.add_column('common_person', 'info', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Person.additional_info'
        db.add_column('common_person', 'additional_info', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Person.info'
        db.delete_column('common_person', 'info')
