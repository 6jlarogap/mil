...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.birth_location_info'
        db.add_column('common_person', 'birth_location_info', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.birth_location_info'
        db.delete_column('common_person', 'birth_location_info')
