...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'PrintingGroup'
        db.delete_table('common_printinggroup')

        # Adding model 'ConflictPrintingGroup'
        db.create_table('common_conflictprintinggroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('common', ['ConflictPrintingGroup'])

        # Adding model 'BurialPrintingGroup'
        db.create_table('common_burialprintinggroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('common', ['BurialPrintingGroup'])

        # Changing field 'MilitaryConflict.type'
        db.alter_column('common_militaryconflict', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.ConflictPrintingGroup'], null=True))

        # Changing field 'BurialType.type'
        db.alter_column('common_burialtype', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.BurialPrintingGroup'], null=True))


    def backwards(self, orm):
        
        # Adding model 'PrintingGroup'
        db.create_table('common_printinggroup', (
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('common', ['PrintingGroup'])

        # Deleting model 'ConflictPrintingGroup'
        db.delete_table('common_conflictprintinggroup')

        # Deleting model 'BurialPrintingGroup'
        db.delete_table('common_burialprintinggroup')

        # Changing field 'MilitaryConflict.type'
        db.alter_column('common_militaryconflict', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.PrintingGroup'], null=True))

        # Changing field 'BurialType.type'
        db.alter_column('common_burialtype', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.PrintingGroup'], null=True))
    ...
    models = {
        ...
        'common.burial': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.StrictLocation']", 'null': 'True', 'blank': 'True'}),
            ...
            'passportid': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '128', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
