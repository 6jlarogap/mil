...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BurialType.type'
        db.add_column('common_burialtype', 'type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.PrintingGroup'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('common_militaryconflicttype', (
            ...
            ('full', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        ...
        # Changing field 'MilitaryConflict.type'
        db.alter_column('common_militaryconflict', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MilitaryConflictType'], null=True))

        # Deleting field 'BurialType.type'
        db.delete_column('common_burialtype', 'type_id')
    ...
    models = {
        ...
        'common.burialtype': {
            ...
            'obid': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.PrintingGroup']", 'null': 'True', 'blank': 'True'})
        },
        'common.citytype': {
        ...
        'common.printinggroup': {
            'Meta': {'object_name': 'PrintingGroup'},
