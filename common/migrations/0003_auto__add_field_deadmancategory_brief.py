...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeadmanCategory.brief'
        db.add_column('common_deadmancategory', 'brief', self.gf('django.db.models.fields.CharField')(default=0, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeadmanCategory.brief'
        db.delete_column('common_deadmancategory', 'brief')
