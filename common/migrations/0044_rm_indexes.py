...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Burial', fields ['location']
        db.delete_unique('common_burial', ['location_id'])

        # Changing field 'Burial.location'
        db.alter_column('common_burial', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.StrictLocation'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Burial.location'
        db.alter_column('common_burial', 'location_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['common.StrictLocation'], unique=True, null=True))

        # Adding unique constraint on 'Burial', fields ['location']
        db.create_unique('common_burial', ['location_id'])
