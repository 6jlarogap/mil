...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'District', fields ['region', 'name']
        db.create_unique('common_district', ['region_id', 'name'])

        # Adding model 'Municipalitet'
        db.create_table('common_municipalitet', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('obid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.District'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=36, db_index=True)),
        ))
        db.send_create_signal('common', ['Municipalitet'])

        # Adding unique constraint on 'Municipalitet', fields ['district', 'name']
        db.create_unique('common_municipalitet', ['district_id', 'name'])

        # Adding field 'GeoCity.country'
        db.add_column('common_geocity', 'country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.GeoCountry'], null=True), keep_default=False)

        # Adding field 'GeoCity.district'
        db.add_column('common_geocity', 'district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.District'], null=True), keep_default=False)

        # Adding field 'GeoCity.municipalitet'
        db.add_column('common_geocity', 'municipalitet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Municipalitet'], null=True, blank=True), keep_default=False)

        # Changing field 'GeoCity.region'
        db.alter_column('common_geocity', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.GeoRegion'], null=True))


    def backwards(self, orm):
        
        # Removing unique constraint on 'Municipalitet', fields ['district', 'name']
        db.delete_unique('common_municipalitet', ['district_id', 'name'])

        # Removing unique constraint on 'District', fields ['region', 'name']
        db.delete_unique('common_district', ['region_id', 'name'])
        ...
        # Deleting model 'Municipalitet'
        db.delete_table('common_municipalitet')

        # Deleting field 'GeoCity.country'
        db.delete_column('common_geocity', 'country_id')

        # Deleting field 'GeoCity.district'
        db.delete_column('common_geocity', 'district_id')

        # Deleting field 'GeoCity.municipalitet'
        db.delete_column('common_geocity', 'municipalitet_id')

        # User chose to not deal with backwards NULL issues for 'GeoCity.region'
        raise RuntimeError("Cannot reverse this migration. 'GeoCity.region' and its values cannot be restored.")
    ...
    models = {
        ...
        'common.district': {
            'Meta': {'unique_together': "(('region', 'name'),)", 'object_name': 'District'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '36', 'db_index': 'True'}),
            'obid': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
