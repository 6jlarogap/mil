...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Burial.state'
        db.add_column('common_burial', 'state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MemorialState'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Burial.state'
        db.delete_column('common_burial', 'state_id')
