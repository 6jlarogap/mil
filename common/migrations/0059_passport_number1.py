...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('common_burial', 'passportid1', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, unique=True, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'common.burial': {
            ...
            'passportid1': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
