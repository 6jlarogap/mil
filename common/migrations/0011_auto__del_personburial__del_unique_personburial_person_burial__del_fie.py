...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Person.date_last_edit'
        db.delete_column('common_person', 'date_last_edit')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Person.date_last_edit'
        raise RuntimeError("Cannot reverse this migration. 'Person.date_last_edit' and its values cannot be restored.")
