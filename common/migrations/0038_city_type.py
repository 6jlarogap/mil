...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CityType'
        db.create_table('common_citytype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=36, db_index=True)),
            ('full_name', self.gf('django.db.models.fields.CharField')(max_length=36, db_index=True)),
        ))
        db.send_create_signal('common', ['CityType'])

        # Adding field 'GeoCity.type'
        db.add_column('common_geocity', 'type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.CityType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'CityType'
        db.delete_table('common_citytype')

        # Deleting field 'GeoCity.type'
        db.delete_column('common_geocity', 'type_id')
    ...
    models = {
        ...
        'common.citytype': {
            ...
            'full_name': ('django.db.models.fields.CharField', [], {'max_length': '36', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
