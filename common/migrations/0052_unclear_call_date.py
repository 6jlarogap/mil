...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PersonCall.date_no_month'
        db.add_column('common_personcall', 'date_no_month', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'PersonCall.date_no_day'
        db.add_column('common_personcall', 'date_no_day', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PersonCall.date_no_month'
        db.delete_column('common_personcall', 'date_no_month')

        # Deleting field 'PersonCall.date_no_day'
        db.delete_column('common_personcall', 'date_no_day')
