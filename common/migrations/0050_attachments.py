...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PersonAttachment'
        db.create_table('common_personattachment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('burial', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Person'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True)),
        ))
        db.send_create_signal('common', ['PersonAttachment'])

        # Adding model 'BurialAttachment'
        db.create_table('common_burialattachment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('burial', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Burial'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True)),
        ))
        db.send_create_signal('common', ['BurialAttachment'])


    def backwards(self, orm):
        
        # Deleting model 'PersonAttachment'
        db.delete_table('common_personattachment')

        # Deleting model 'BurialAttachment'
        db.delete_table('common_burialattachment')
