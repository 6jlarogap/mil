...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.oblocationid'
        db.add_column('common_person', 'oblocationid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Burial.oblocationid'
        db.add_column('common_burial', 'oblocationid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.oblocationid'
        db.delete_column('common_person', 'oblocationid')

        # Deleting field 'Burial.oblocationid'
        db.delete_column('common_burial', 'oblocationid')
