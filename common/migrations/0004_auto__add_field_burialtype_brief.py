...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BurialType.brief'
        db.add_column('common_burialtype', 'brief', self.gf('django.db.models.fields.CharField')(default=0, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BurialType.brief'
        db.delete_column('common_burialtype', 'brief')
