...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MemorialState'
        db.create_table('common_memorialstate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('common', ['MemorialState'])

        # Adding field 'Burial.state_memorial'
        db.add_column('common_burial', 'state_memorial', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MemorialState'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'MemorialState'
        db.delete_table('common_memorialstate')

        # Deleting field 'Burial.state_memorial'
        db.delete_column('common_burial', 'state_memorial_id')
    ...
    models = {
        ...
        'common.burial': {
            ...
            'state_memorial': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.MemorialState']", 'null': 'True', 'blank': 'True'}),
