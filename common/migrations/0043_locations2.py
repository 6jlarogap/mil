...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Burial.location'
        db.add_column('common_burial', 'location', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['common.StrictLocation'], unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Burial.location'
    ...
    models = {
        ...
        'common.burial': {
            ...
            'location': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.StrictLocation']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
