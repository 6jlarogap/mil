...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BurialEditCause.date_edit'
        db.add_column('common_burialeditcause', 'date_edit', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 7, 15), blank=True), keep_default=False)

        # Adding field 'BurialEditCause.user'
        db.add_column('common_burialeditcause', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)

        # Adding field 'Person.burial'
        db.add_column('common_person', 'burial', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Burial'], null=True, blank=True), keep_default=False)

        # Deleting field 'Burial.date_last_edit'
        db.delete_column('common_burial', 'date_last_edit')


    def backwards(self, orm):
        
        # Deleting field 'BurialEditCause.date_edit'
        db.delete_column('common_burialeditcause', 'date_edit')

        # Deleting field 'BurialEditCause.user'
        db.delete_column('common_burialeditcause', 'user_id')

        # Deleting field 'Person.burial'
        db.delete_column('common_person', 'burial_id')

        # User chose to not deal with backwards NULL issues for 'Burial.date_last_edit'
        raise RuntimeError("Cannot reverse this migration. 'Burial.date_last_edit' and its values cannot be restored.")
    ...
    models = {
        ...
        'common.burial': {
            ...
            'persons': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'pers'", 'symmetrical': 'False', 'through': "orm['common.PersonBurial']", 'to': "orm['common.Person']"}),
        ...
        'common.closedburial': {
            ...
            'burial_from': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['common.Burial']", 'unique': 'True', 'primary_key': 'True'}),
