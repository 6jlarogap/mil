...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Burial.date_of_update'
        db.add_column('common_burial', 'date_of_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 11, 13, 2, 27, 17, 95995), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Burial.date_of_update'
        db.delete_column('common_burial', 'date_of_update')
