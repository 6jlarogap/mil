...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Burial', fields ['date_closed']
        db.create_index('common_burial', ['date_closed'])

        # Adding index on 'Burial', fields ['date_of_creation']
        db.create_index('common_burial', ['date_of_creation'])

        # Adding index on 'Burial', fields ['date_burried']
        db.create_index('common_burial', ['date_burried'])

        # Adding index on 'Burial', fields ['date_discovered']
        db.create_index('common_burial', ['date_discovered'])

        # Adding index on 'Burial', fields ['date_passport']
        db.create_index('common_burial', ['date_passport'])

        # Adding index on 'Burial', fields ['is_registered']
        db.create_index('common_burial', ['is_registered'])

        # Adding index on 'Burial', fields ['date_of_update']
        db.create_index('common_burial', ['date_of_update'])

        # Adding index on 'Burial', fields ['passportid']
        db.create_index('common_burial', ['passportid'])

        # Adding index on 'Burial', fields ['date_gosznak']
        db.create_index('common_burial', ['date_gosznak'])

        # Adding index on 'Burial', fields ['is_trash']
        db.create_index('common_burial', ['is_trash'])

        # Adding index on 'Burial', fields ['date_memorial']
        db.create_index('common_burial', ['date_memorial'])


    def backwards(self, orm):
        
        # Removing index on 'Burial', fields ['date_memorial']
        db.delete_index('common_burial', ['date_memorial'])

        # Removing index on 'Burial', fields ['is_trash']
        db.delete_index('common_burial', ['is_trash'])

        # Removing index on 'Burial', fields ['date_gosznak']
        db.delete_index('common_burial', ['date_gosznak'])

        # Removing index on 'Burial', fields ['passportid']
        db.delete_index('common_burial', ['passportid'])

        # Removing index on 'Burial', fields ['date_of_update']
        db.delete_index('common_burial', ['date_of_update'])

        # Removing index on 'Burial', fields ['is_registered']
        db.delete_index('common_burial', ['is_registered'])

        # Removing index on 'Burial', fields ['date_passport']
        db.delete_index('common_burial', ['date_passport'])

        # Removing index on 'Burial', fields ['date_discovered']
        db.delete_index('common_burial', ['date_discovered'])

        # Removing index on 'Burial', fields ['date_burried']
        db.delete_index('common_burial', ['date_burried'])

        # Removing index on 'Burial', fields ['date_of_creation']
        db.delete_index('common_burial', ['date_of_creation'])

        # Removing index on 'Burial', fields ['date_closed']
        db.delete_index('common_burial', ['date_closed'])
