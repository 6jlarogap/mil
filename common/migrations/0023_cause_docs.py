...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PersonEditCause.file'
        db.add_column('common_personeditcause', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PersonEditCause.file'
        db.delete_column('common_personeditcause', 'file')
