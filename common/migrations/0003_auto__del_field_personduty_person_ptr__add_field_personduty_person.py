...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PersonDuty.person_ptr'
        db.delete_column('common_personduty', 'person_ptr_id')

        # Adding field 'PersonDuty.person'
        db.add_column('common_personduty', 'person', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['common.Person'], unique=True, primary_key=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PersonDuty.person_ptr'
        raise RuntimeError("Cannot reverse this migration. 'PersonDuty.person_ptr' and its values cannot be restored.")

        # Deleting field 'PersonDuty.person'
        db.delete_column('common_personduty', 'person_id')
