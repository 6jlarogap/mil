...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('common_district', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.GeoRegion'], null=True))

        # Changing field 'GeoRegion.country'
        db.alter_column('common_georegion', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.GeoCountry'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'District.region'
        raise RuntimeError("Cannot reverse this migration. 'District.region' and its values cannot be restored.")

        # Adding unique constraint on 'District', fields ['region', 'name']
        db.create_unique('common_district', ['region_id', 'name'])

        # User chose to not deal with backwards NULL issues for 'GeoRegion.country'
        raise RuntimeError("Cannot reverse this migration. 'GeoRegion.country' and its values cannot be restored.")
