...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeadmanCategory.ordering'
        db.add_column('common_deadmancategory', 'ordering', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeadmanCategory.ordering'
        db.delete_column('common_deadmancategory', 'ordering')
