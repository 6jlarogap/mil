...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Burial.names_count'
        db.add_column('common_burial', 'names_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Burial.names_count'
        db.delete_column('common_burial', 'names_count')
