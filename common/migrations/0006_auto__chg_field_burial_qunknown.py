...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Burial.qunknown'
        db.alter_column('common_burial', 'qunknown', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Burial.qunknown'
        db.alter_column('common_burial', 'qunknown', self.gf('django.db.models.fields.FloatField')(null=True))
