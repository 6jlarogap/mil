...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Burial.qunknown'
        db.delete_column('common_burial', 'qunknown')


    def backwards(self, orm):
        
        # Adding field 'Burial.qunknown'
        db.add_column('common_burial', 'qunknown', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
