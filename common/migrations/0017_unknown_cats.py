...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BurialCategory'
        db.create_table('common_burialcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='burial_categories', to=orm['common.DeadmanCategory'])),
            ('burial', self.gf('django.db.models.fields.related.ForeignKey')(related_name='burial_categories', to=orm['common.Burial'])),
            ('known', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('unknown', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('common', ['BurialCategory'])


    def backwards(self, orm):
        
        # Deleting model 'BurialCategory'
        db.delete_table('common_burialcategory')
