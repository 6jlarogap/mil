...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Burial', fields ['passportid']
        db.create_unique('common_burial', ['passportid'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Burial', fields ['passportid']
        db.delete_unique('common_burial', ['passportid'])
