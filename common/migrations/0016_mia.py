...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.mia'
        db.add_column('common_person', 'mia', self.gf('django.db.models.fields.BooleanField')(), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.mia'
        db.delete_column('common_person', 'mia')
