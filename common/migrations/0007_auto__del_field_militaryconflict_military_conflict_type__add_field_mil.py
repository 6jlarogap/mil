...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MilitaryConflict.military_conflict_type'
        db.delete_column('common_militaryconflict', 'military_conflict_type_id')

        # Adding field 'MilitaryConflict.type'
        db.add_column('common_militaryconflict', 'type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MilitaryConflictType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'MilitaryConflict.military_conflict_type'
        db.add_column('common_militaryconflict', 'military_conflict_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MilitaryConflictType'], null=True, blank=True), keep_default=False)

        # Deleting field 'MilitaryConflict.type'
        db.delete_column('common_militaryconflict', 'type_id')
