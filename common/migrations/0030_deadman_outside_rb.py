...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.outside_rb'
        db.add_column('common_person', 'outside_rb', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.outside_rb'
        db.delete_column('common_person', 'outside_rb')
