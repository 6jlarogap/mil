...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.birth_date_no_month'
        db.add_column('common_person', 'birth_date_no_month', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Person.birth_date_no_day'
        db.add_column('common_person', 'birth_date_no_day', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Person.death_date_no_month'
        db.add_column('common_person', 'death_date_no_month', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Person.death_date_no_day'
        db.add_column('common_person', 'death_date_no_day', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.birth_date_no_month'
        db.delete_column('common_person', 'birth_date_no_month')

        # Deleting field 'Person.birth_date_no_day'
        db.delete_column('common_person', 'birth_date_no_day')

        # Deleting field 'Person.death_date_no_month'
        db.delete_column('common_person', 'death_date_no_month')

        # Deleting field 'Person.death_date_no_day'
        db.delete_column('common_person', 'death_date_no_day')
