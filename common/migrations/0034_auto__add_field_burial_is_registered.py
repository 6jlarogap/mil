...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Burial.is_registered'
        db.add_column('common_burial', 'is_registered', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Burial.is_registered'
        db.delete_column('common_burial', 'is_registered')
