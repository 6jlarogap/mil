...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Person', fields ['last_name']
        db.create_index('common_person', ['last_name'])

        # Adding index on 'Person', fields ['patronymic']
        db.create_index('common_person', ['patronymic'])

        # Adding index on 'Person', fields ['first_name']
        db.create_index('common_person', ['first_name'])

        # Adding index on 'Person', fields ['death_date']
        db.create_index('common_person', ['death_date'])

        # Adding index on 'Person', fields ['birth_date']
        db.create_index('common_person', ['birth_date'])


    def backwards(self, orm):
        
        # Removing index on 'Person', fields ['birth_date']
        db.delete_index('common_person', ['birth_date'])

        # Removing index on 'Person', fields ['death_date']
        db.delete_index('common_person', ['death_date'])

        # Removing index on 'Person', fields ['first_name']
        db.delete_index('common_person', ['first_name'])

        # Removing index on 'Person', fields ['patronymic']
        db.delete_index('common_person', ['patronymic'])

        # Removing index on 'Person', fields ['last_name']
        db.delete_index('common_person', ['last_name'])
