...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Person', fields ['is_trash']
        db.create_index('common_person', ['is_trash'])


    def backwards(self, orm):
        
        # Removing index on 'Person', fields ['is_trash']
        db.delete_index('common_person', ['is_trash'])
