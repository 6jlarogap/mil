...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Comissariat'
        db.create_table('common_comissariat', (
        ...
        db.send_create_signal('common', ['Comissariat'])

        # Changing field 'PersonCall.unit'
        db.alter_column('common_personcall', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Comissariat'], null=True))


    def backwards(self, orm):
        
        # Deleting model 'Comissariat'
        db.delete_table('common_comissariat')

        # Changing field 'PersonCall.unit'
        db.alter_column('common_personcall', 'unit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.MilitaryUnit'], null=True))
