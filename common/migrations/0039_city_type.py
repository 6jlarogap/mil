...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CityType.full_name'
        db.alter_column('common_citytype', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Removing index on 'CityType', fields ['full_name']
        db.delete_index('common_citytype', ['full_name'])


    def backwards(self, orm):
        
        # Adding index on 'CityType', fields ['full_name']
        db.create_index('common_citytype', ['full_name'])

        # User chose to not deal with backwards NULL issues for 'CityType.full_name'
        raise RuntimeError("Cannot reverse this migration. 'CityType.full_name' and its values cannot be restored.")
