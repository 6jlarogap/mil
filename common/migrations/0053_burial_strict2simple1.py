...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Burial.old_location'
        db.add_column('common_burial', 'old_location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.StrictLocation'], null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Burial.old_location'
        db.delete_column('common_burial', 'old_location_id')
    ...
    models = {
        ...
        'common.burial': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'new_loc'", 'null': 'True', 'to': "orm['common.StrictLocation']"}),
