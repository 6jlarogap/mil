...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ClosedBurial.burial'
        db.delete_column('common_closedburial', 'burial_id')

        # Adding field 'ClosedBurial.burial_to'
        db.add_column('common_closedburial', 'burial_to', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='burial_to', to=orm['common.Burial']), keep_default=False)

        # Changing field 'ClosedBurial.burial_from'
        db.alter_column('common_closedburial', 'burial_from_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['common.Burial'], unique=True, primary_key=True))

        # Adding unique constraint on 'ClosedBurial', fields ['burial_from']
        db.create_unique('common_closedburial', ['burial_from_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ClosedBurial', fields ['burial_from']
        db.delete_unique('common_closedburial', ['burial_from_id'])

        # User chose to not deal with backwards NULL issues for 'ClosedBurial.burial'
        raise RuntimeError("Cannot reverse this migration. 'ClosedBurial.burial' and its values cannot be restored.")

        # Deleting field 'ClosedBurial.burial_to'
        db.delete_column('common_closedburial', 'burial_to_id')

        # Changing field 'ClosedBurial.burial_from'
        db.alter_column('common_closedburial', 'burial_from_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Burial']))
