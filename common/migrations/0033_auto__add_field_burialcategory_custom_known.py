...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BurialCategory.custom_known'
        db.add_column('common_burialcategory', 'custom_known', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BurialCategory.custom_known'
        db.delete_column('common_burialcategory', 'custom_known')
