...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Burial.location'
        db.delete_column('common_burial', 'location_id')
        db.add_column('common_burial', 'location', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['common.SimpleLocation']))

    def backwards(self, orm):
        db.delete_column('common_burial', 'location_id')
        db.add_column('common_burial', 'location', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['common.StrictLocation']))
    ...
    models = {
        ...
        'common.burial': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'new_loc'", 'null': 'True', 'to': "orm['common.SimpleLocation']"}),
            ...
            'old_location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.StrictLocation']", 'null': 'True', 'blank': 'True'}),
